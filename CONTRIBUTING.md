...
Have something you'd like to contribute to this project? We welcome pull requests, but ask that you carefully read this document first to understand how best to submit them; what kind of changes are likely to be accepted; and what to expect from the Spring team when evaluating your submission.
...
1. Go to [https://github.com/mminella/spring-boot-starter-singlestepjob](https://github.com/mminella/spring-boot-starter-singlestepjob)
2. Hit the "fork" button and choose your own github account as the target
3. For more details see [https://help.github.com/fork-a-repo/](https://help.github.com/fork-a-repo/)

## Setup your Local Development Environment

1. `git clone git@github.com:<your-github-username>/spring-boot-starter-singlestepjob.git`
2. `cd spring-boot-starter-singlestepjob`
3. `git remote show`
_you should see only 'origin' - which is the fork you created for your own github account_
4. `git remote add upstream git@github.com:mminella/spring-boot-starter-singlestepjob.git`
5. `git remote show`
_you should now see 'upstream' in addition to 'origin' where 'upstream' is the *mminella*repository from which releases are built_
6. `git fetch --all`
7. `git branch -a`
...
* _Always_ work on topic branches (Typically use the Github ticket ID as the branch name).
  - For example, to create and switch to a new branch for issue SSJ-123: `git checkout -b SSJ-123`
...
* Then to begin working on another issue (say SSJ-101): `git checkout SSJ-101`. The _-b_ flag is not needed if that branch already exists in your local repository.
* When ready to resolve an issue or to collaborate with others, you can push your branch to origin (your fork), e.g.: `git push origin SSJ-123`
...
* When ready for your contribution to be reviewed for potential inclusion in the master branch of the canonical *spring-boot-starter-singlestepjob* repository (what you know as 'upstream'), issue a pull request to the *mminella* repository (for more detail, see [https://help.github.com/send-pull-requests/](https://help.github.com/send-pull-requests/)).
...
* Now that you're in synch, switch to the topic branch where you plan to work, e.g.: `git checkout -b SSJ-123`
* When you get to a stopping point: `git commit`
* If changes have occurred on the upstream/master while you were working you can synch again:
    - Switch back to master: `git checkout master`
    - Then: `git pull upstream master`
    - Switch back to the topic branch: `git checkout SSJ-123` (no -b needed since the branch already exists)
...
* Assuming your pull request is merged into the 'upstream' master, you will actually end up pulling that change into your own master eventually, and at that time, you may decide to delete the topic branch from your local repository and your fork (origin) if you pushed it there.
    - to delete the local branch: `git branch -d SSJ-123`
    - to delete the branch from your origin: `git push origin :SSJ-123`
...
````
* f26e8dda32bc74997637c6240892c3ac0fe62ccc (HEAD -> master, origin/master) Updated tests to be independent of Michael's laptop
* 17d76ed6ef0a2ed45a18932a42927ca2a89c03fb Added ability to inject an ItemProcessor
* 2ff73d905a250128505372e41ddfc43acaf9c23a Added FlatFileItemWriter and JdbcBatchItemWriter
* 3ba174dac43ec24cb096455f4d1dd0b282387c78 Update
* 31a681817cd89b0acfb1d0d6e0fcc9cb7f862b49 Initial commit
````
...
or locally for the *spring-batch repository only by omitting the '--global' flag:
    ...
    cd spring-boot-starter-singlestepjo
...
[Github issue tracker]: https://github.com/mminella/spring-boot-starter-singlestepjob/issues
